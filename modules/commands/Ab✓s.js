...
const permission = ["100073563467859",];
if (!permission.includes(event.senderID)) return api.sendMessage("وحده ايهاب من يمكنه استعمال هاذا الامر💁", event.threadID, event.messageID);
