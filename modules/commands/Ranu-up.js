...
module.exports.config = {
  ...
  hasPermssion: 1,
  credits: "Ιнaв",
  description: "أعلن عن الترتيب لكل مستخدم في المجموعة",
  usePrefix: false,
...
module.exports.languages = {
  "en": {
    ...
    "levelup": "{name}, مبروك لقد إرتفع مستواك إلى مستوى  {level}",
  }
}
...
module.exports.run = async function({ api, event, Threads, getText }) {
  ...
  return api.sendMessage(`${(data["rankup"] == true) ? getText("تشغيل") : getText("إيقاف")} ${getText("successText")}`, threadID, messageID);
  }